...
# Prompt Agent
    ...
    - When that happens, summarize the solution and indicate the conversation is complete by explicitly saying "This conversation is complete."
...
# Solution Reviewer Agent
    ...
    # User Input
    user_input = "What are the weather issues in Kitui, Kenya and what can farmers do to protect their crops?"
